...
/**
 * Ventana de inicio de sesion. Es la primera pantalla que ve el usuario
 * cuando abre el programa (la abrimos desde Arranque).
 *
 * @author CARLOS
 */
public class IniciarSesion extends javax.swing.JFrame {
    ...
    /**
     * Aqui ponemos los colores y las fuentes que queriamos para la
     * ventana, cosas que el Form Editor de NetBeans no deja configurar
     * tan facil desde el diseñador, entonces lo hacemos por codigo para
     * no romper lo que ya genera automaticamente.
     */
    ...
    private void btnIniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {                                              
        ...
        if (Autenticacion.validarCredenciales(correo, clave)) {
            ...
            //aqui deberiamos abrir la ventana principal con las
            // actividades del sistema, pero eso todavia no esta hecho
        } else{
            javax.swing.JOptionPane.showMessageDialog(this,
